...
export const products: Product[] = [
  {
    ...
    images: [
      "/flexible-panel-living-room-premium.jpg",
      "/flexible-panel-tv-wall.jpeg",
      "/flexible-panel-colors.jpeg",
      "/flexible-panel-bend.jpeg",
      "/flexible-panel-black-room.jpeg",
      "/images/81zbr4xu-rl.jpg",
      "/images/81dlw3kdxzl.jpg",
      "/images/71lucljlfpl.jpg",
      "/images/71ep5p80czl.jpg",
      "/images/81xcyf0mg6l.jpg",
    ],
    features: [
      "Flexible backing - bends to any curve",
      "270x110cm coverage per piece",
      "Superior NRC rating 0.85",
    ...
    material: "MDF Wood Slats / Acoustic Felt Backing",
    inStock: true,
    badge: "Bestseller",
    onSale: true,
    colors: [
  ...
  // French version of Flexible Acoustic Panel (FR market)
  {
    ...
    hidden: true,
    images: [
      "/panel-acoustic-diagram.jpg",
      "/panel-flexible-isometric.jpg",
      "/panel-dimensions-bedroom.jpg",
      "/panel-wood-texture-detail.jpg",
      "/panel-modern-living-room.jpg",
      "/panel-acoustic-ripple-detail.jpg",
      "/panel-materials-sustainable.jpg",
    ],
    features: [
    ...
    onSale: true,
    colors: [
      { id: "natural-oak-fr", name: "Chene Naturel", hex: "#D4B896", image: "/panel-color-natural-oak.jpg" },
      { id: "smoked-oak-fr", name: "Chene Fume", hex: "#8B7355", image: "/panel-color-smoked-oak.jpg" },
      { id: "dark-smoked-fr", name: "Chene Fume Fonce", hex: "#5D4037", image: "/panel-color-dark-smoked.jpg" },
      { id: "grey-oak-fr", name: "Chene Gris", hex: "#9E9E9E", image: "/panel-color-grey.jpg" },
    ],
  },
  {
  ...
  },
  {
    ...
    category: "lighting",
    images: [
      "/led-strip-kit-main-featured.jpg",
      "/led-kit-ctrlcv-1.jpg",
      "/led-kit-ctrlcv-2.jpg",
      "/led-kit-ctrlcv-3.jpg",
      "/led-kit-ctrlcv-4.jpg",
      "/led-kit-ctrlcv-5.jpg",
      "/led-strip-kit-cctvl-complete.jpg",
      "/led-kit-ctrlcv-main.jpg",
      "/led-strip-01.jpg",
      "/led-strip-02.jpg",
      "/led-strip-03.jpg",
      "/led-strip-05.jpg",
  ...
  // French version of LED Strip Kit
  {
    ...
    longDescription:
      "Sublimez vos panneaux muraux avec notre Kit Ruban LED Encastre professionnel, concu specifiquement pour une installation derriere les panneaux. Ce kit complet de 8 pieces comprend des rubans LED de plusieurs tailles (18\", 26\", 34\", 42\" - 2 de chaque), un transformateur LED premium, un variateur a capteur tactile et tous les cables de connexion. La temperature de couleur blanc chaud de 3000K cree une lueur ambiante chaleureuse, tandis que le variateur tactile permet un reglage de 10% a 100% de luminosite avec fonction memoire. Caracteristiques : ruban adhesif epais personnalise pour une fixation superieure et boitier en aluminium noir qui disparait derriere les panneaux. Le systeme de connexion rapide rend l'installation sans effort. Parfait pour les chambres, salons, bureaux et murs de canape.",
    price: 52.32,
    currency: "EUR",
    category: "lighting",
    hidden: true,
  ...
  // French version of Wall Cleaner
  {
    ...
    name: "Nettoyant de Preparation Murale",
    description: "Nettoyant mural moussant professionnel pour la preparation des surfaces avant installation. Elimine la salete, la graisse et les taches sans endommager les surfaces.",
    longDescription:
      "Preparez parfaitement vos murs avant l'installation de panneaux acoustiques avec notre Nettoyant Mural Moussant de qualite professionnelle. Cette formule puissante mais douce elimine la salete, les eraflures, la graisse, les salissures, les marqueurs, les crayons, les residus de nicotine, les empreintes digitales et le maquillage sans endommager les surfaces peintes. La technologie de mousse adherente assure l'absence de coulures et un nettoyage rapide sans frotter. Sans danger sur la plupart des murs peints, portes, plinthes, armoires et papiers peints lavables. Fabrique aux USA avec des materiaux sources mondialement. Essentiel pour obtenir la meilleure adherence et finition lors de l'installation de panneaux muraux.",
    price: 14.88,
    currency: "EUR",
    category: "decor",
    hidden: true,
    ...
    features: [
      ...
      "Mousse adherente - sans coulures",
      "Sans danger sur murs peints",
      "Elimine salete, graisse, marqueurs, crayons",
      "Elimine residus de nicotine et empreintes",
      "Fonctionne sur armoires et plinthes",
      "Flacon de 18 oz (510g)",
      "Fabrique aux USA",
    ],
    dimensions: "18 oz (510g)",
