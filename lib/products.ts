...
export const products: Product[] = [
  ...
  // French version of Flexible Acoustic Panel (FR market)
  {
    ...
    hidden: true,
    images: [
      "/fr-panel-isometric.png",
      "/fr-panel-dimensions-room.png",
      "/fr-panel-closeup-badges.png",
      "/fr-panel-exploded-diagram.png",
      "/fr-panel-diagonal-detail.png",
      "/fr-panel-living-room-modern.png",
      "/fr-panel-scandinavian-room.png",
    ],
    features: [
  ...
  // French version of LED Strip Kit
  {
    ...
    hidden: true,
    images: [
      "/led-kit-product-01.png",
      "/led-kit-product-02.png",
      "/led-kit-product-03.png",
      "/led-kit-product-04.png",
      "/led-kit-product-05.png",
    ],
    features: [
