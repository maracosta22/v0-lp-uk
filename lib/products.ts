...
export const products: Product[] = [
  {
    ...
    images: [
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/PANEL0101-NGJvMDss7ALruvF8cM2J08UphnUHDP.webp",
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/PANEL0202-ShqTBvqxVBT3VyP9RT9DsqQtOkU0C4.jpg",
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/PANEL0303-zDiM4skM3kqMEUU3kilXD1wac8O86F.webp",
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Gemini_Generated_Image_ngxwywngxwywngxw%20%281%29.png-uaP1ZpskEmsCzBtAsQcZqMxcxxC3Jw.jpeg",
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Gemini_Generated_Image_9fuftb9fuftb9fuf.png-kBTnAoGLWnLbpeBbjngptpypyAPEOA.jpeg",
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/PANEL0808-joGU6M7iWzFr3oCuPb31HvWQXHoB5I.webp",
    ],
    inStock: true,
    badge: "Bestseller",
    onSale: true,
  ...
  // Test Product FR
  {
    ...
    name: "Produit Test",
    description: "Produit de test pour verification du systeme - Prix symbolique de 2 dollars",
    longDescription:
      "Ceci est un produit de test cree pour verifier le bon fonctionnement du systeme de commerce electronique avec la devise USD (Dollar americain). Ce produit a un prix symbolique de $2.00 et ne doit etre utilise qu'a des fins de test et de validation.",
    price: 2.00,
    currency: "USD",
    category: "decor",
    hidden: true,
