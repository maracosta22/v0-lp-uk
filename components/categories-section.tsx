...
const categories = [
  {
    ...
    description: "Acoustiques & décoratifs",
    ...
    <section className="py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          ...
          <h2 className="font-serif text-3xl font-normal sm:text-4xl lg:text-5xl">Acheter par Catégorie</h2>
          <p className="mx-auto mt-5 max-w-2xl text-muted-foreground">
            Explorez nos collections soigneusement sélectionnées, chacune conçue pour apporter chaleur et caractère à votre intérieur.
          </p>
        </div>
