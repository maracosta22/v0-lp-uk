...
export function StickyCartBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-t border-gray-200 shadow-2xl px-4 py-3 sm:px-6 animate-in slide-in-from-bottom-full duration-300">
      <div className="mx-auto max-w-7xl flex items-center gap-3">
        <div className="flex-shrink-0 w-10 h-10 rounded-lg overflow-hidden bg-secondary">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-red-600 hidden sm:inline">-{discount}%</span>
          </div>
        </div>
