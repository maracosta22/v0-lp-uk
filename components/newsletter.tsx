    ...
    <section className="border-t border-border/50 py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-serif text-3xl font-normal sm:text-4xl lg:text-5xl">Rejoignez la Communauté WOOD SHOP</h2>
          <p className="mt-5 text-muted-foreground">
            Inscrivez-vous pour recevoir des offres exclusives, de l&apos;inspiration design et un accès anticipé aux nouvelles collections.
          </p>
          ...
          <p className="mt-6 text-xs text-muted-foreground">
            En vous inscrivant, vous acceptez notre Politique de Confidentialité. Désabonnez-vous à tout moment.
          </p>
        </div>
      </div>
    </section>
