...
export function ProductGallery({ images, productName }: ProductGalleryProps) {
  ...
  return (
    <div className="flex flex-col gap-3 overflow-hidden max-w-full">
      <div className="relative aspect-square w-full max-w-[350px] sm:max-w-[400px] mx-auto overflow-hidden bg-secondary">
        <Image
      ...
      {images.length > 1 && (
        <div className="relative max-w-[350px] sm:max-w-[400px] mx-auto w-full overflow-hidden">
          <div className="flex gap-1 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent">
            {images.map((image, index) => (
              <button
                ...
                className={cn(
                  "relative w-10 h-10 sm:w-12 sm:h-12 min-w-[40px] sm:min-w-[48px] min-h-[40px] sm:min-h-[48px] overflow-hidden bg-secondary transition-all flex-shrink-0",
