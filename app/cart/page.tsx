...
export default function CartPage() {
  ...
  const hasFlexiblePanel = items.some((item) => item.product.id === "prod_U2rumuoWXebtgj")
  ...
  // Default to EUR for French market
      ...
      <div className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-md text-center">
            ...
            <p className="mt-4 text-muted-foreground">Il semble que vous n&apos;ayez pas encore ajouté d&apos;articles à votre panier.</p>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {hasFlexiblePanel && (
          <div className="mb-8 flex items-center gap-3 rounded-md bg-amber-50 border border-amber-200 px-4 py-3">
            ...
            <div>
              <p className="text-sm font-semibold text-amber-800">Les articles de votre panier se vendent rapidement !</p>
              <p className="text-xs text-amber-700">
                Seulement 30 unités de Panneau Acoustique Flexible restantes. Finalisez votre commande maintenant.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="mb-8 flex items-center gap-3 rounded-md bg-red-50 border border-red-200 px-4 py-3">
            ...
            <div>
              ...
              <p className="text-xs text-red-700">
                Votre panier contient des produits de différents marchés. Veuillez vider votre panier et sélectionner des produits du même marché.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-secondary p-6">
              <h2 className="font-serif text-xl">Récapitulatif de Commande</h2>
              ...
              <div className="mt-6 space-y-4">
                ...
                {hasMixedCurrencies ? (
                  <div className="text-center text-sm text-red-600 font-semibold p-4 bg-red-50 rounded">
                    Veuillez vider votre panier pour procéder au paiement
                  </div>
                ) : (
              ...
              <p className="mt-4 text-center text-xs text-muted-foreground">Paiement sécurisé par Stripe</p>
            </div>
          </div>
        </div>
      </div>
